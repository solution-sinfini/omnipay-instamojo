...
class GatewayTest extends GatewayTestCase
{
    ...
    public function testPurchase()
    {
        ...
        $this->assertInstanceOf('Omnipay\Instamojo\Message\PurchaseRequest', $request);
    ...
    public function testRefund()
    {
        ...
        $this->assertInstanceOf('Omnipay\Instamojo\Message\RefundRequest', $request);
        $this->assertSame('10.00', $request->getAmount());
        $this->assertSame('USD', $request->getCurrency());
    }
    ...
    public function testVoid()
    {
        ...
        $this->assertInstanceOf('Omnipay\Instamojo\Message\VoidRequest', $request);
    ...
    public function testAuthorize()
    {
        ...
        $this->assertInstanceOf('Omnipay\Instamojo\Message\AuthorizeRequest', $request);
        $this->assertSame('10.00', $request->getAmount());
        $this->assertSame('USD', $request->getCurrency());
    }
    ...
    public function testCapture()
    {
        ...
        $this->assertInstanceOf('Omnipay\Instamojo\Message\CaptureRequest', $request);
        $this->assertSame('10.00', $request->getAmount());
        $this->assertSame('USD', $request->getCurrency());
